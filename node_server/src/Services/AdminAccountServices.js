...
const addAdminAccount = async (adminAccountData) => {
    try {
        const newAdminAccountData = await AdminAccountModel.create(adminAccountData);
...
const getAdminAccountByKey = async (key, value) => {
    try {
      ...
      return await AdminAccountModel.findAll({
        where: {
...
const updateAdminAccountToken = async (adminAccountData) => {
  try {
    const result = await AdminAccountModel.update(
      {
